...
var getMenuData = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("https://ucad.northeurope.cloudapp.azure.com/api/api/menu")];
            case 1:
                response = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch("https://ucad.northeurope.cloudapp.azure.com/api/api/menu/" + data.menu_id, {
                        method: "PUT",
                        headers: {
